...
UN_GDP_data  <-  read_excel(here::here("data bases","Download-GDPconstant-USD-countries.xls"), # Excel filename
...
First, I will tidy the data. Currently, it is in wide format and I convert it into long, tidy format. 
```{r reshape_GDP_data}
...
First, I want to show the development of GDP components over time for Germany, India. and the United States
...
Secondly, recall that GDP is the sum of Household Expenditure (Consumption *C*), Gross Capital Formation (business investment *I*), Government Expenditure (G) and Net Exports (exports - imports). Even though there is an indicator `Gross Domestic Product (GDP)` in my dataframe, I would like you to recalculate it given its components discussed above.

> What is the % difference between what the recalculated GDP and the GDP figure included in my dataframe?
...
> Customizing the list of countries using "United States", "India", and "Germany"
